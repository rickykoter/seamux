...
machine, side by side:
    ...
    active/sync-loan-purpose-ofs-to-pas   CWD=…/main-repo.worktrees/handle-purpose-change
    active/figure-lending-entity-cutover  CWD=…/.claude/deep-plan/keys
...
`state/<slug>.json` carries the plan's real `root` — `…worktrees/figure-cutover-plan`
